<div class="p-10">
    <h3 class="mb-5 text-3xl font-bold text-gray-800 my-3">
        {{ $vacante->titulo }}
    </h3>
    <div class="md:grid md:grid-cols-2 bg-gray-100 p-3 my-6">
    ...
    <div class="md:grid md:grid-cols-6 gap-4">
        <div class="md:col-span-2">
            <img src="{{ asset('storage/vacantes/' . $vacante->imagen) }}" alt="imagen_vacante">
        </div>
        <div class="md:col-span-4">
            <h2 class="text-2xl font-bold mt-5">Descripcion del puesto</h2>
    ...
    @guest
        <div class="mt-5 bg-gray-50 border border-dashed p-5 text-center">
            <p>
                ¿Deseas postular a la vacante?
                <a href="{{ route('register') }}" class="font-bold text-indigo-600">
                    Obten una cuenta y aplica a esta y otras
                    vacantes
                </a>
            </p>
